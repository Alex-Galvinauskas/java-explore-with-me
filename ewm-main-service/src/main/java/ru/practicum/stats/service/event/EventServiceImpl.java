...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto addEvent(Long userId, NewEventDto newEventDto) {
        ...
        LocalDateTime eventDate = validator.parseAndValidateEventDate(newEventDto.getEventDate(), 2);
    ...
    public EventFullDto updateEventByUser(Long userId, Long eventId, UpdateEventUserRequest request) {
        ...
        if (request.getEventDate() != null) {
            LocalDateTime newEventDate = validator.parseAndValidateEventDate(request.getEventDate(), 2);
            event.setEventDate(newEventDate);
        }
